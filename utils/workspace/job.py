...
class Job:
    def __init__(self, name: str, data: dict, job_manager) -> None:
        ...
        self.components_inventory: ComponentsInventory = (
            self.job_manager.components_inventory
        )
        self.laser_cut_inventory: LaserCutInventory = (
            self.job_manager.laser_cut_inventory
        )
    ...
    def to_dict(self) -> dict:
        ...
        for laser_cut_part in self.get_all_laser_cut_parts():
            if inventory_laser_cut_part := self.laser_cut_inventory.get_laser_cut_part_by_name(
                laser_cut_part.name
            ):

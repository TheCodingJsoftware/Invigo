...
class GetPurchaseOrderWorker(BaseWorker):
    def __init__(self, purchase_order_id: int):
        super().__init__(name="GetPurchaseOrder")
        self.url = f"{self.DOMAIN}/purchase_orders/get_purchase_order/{purchase_order_id}"
    ...
    def do_work(self):
        with requests.Session() as session:
            ...
            return (response_data, self.purchase_order_id)

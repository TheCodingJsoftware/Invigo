...
__license__: str = "MIT"
__version__: str = "v3.0.10"
__updated__: str = "2024-06-03 10:17:59"
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        if days_from_last_price_history_assessment > self.settings_file.get_value("days_until_new_price_history_assessment"):
            ...
            msg.setWindowTitle("Price Assessment")
            msg.setText(f"It has been {self.settings_file.get_value('days_until_new_price_history_assessment')} days until the last price assessment. A new price history file has been created in the 'Price History Files' directory.")
            msg.exec()

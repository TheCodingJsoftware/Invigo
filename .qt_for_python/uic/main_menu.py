...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.inventory_page.setGeometry(QtCore.QRect(0, 0, 477, 519))
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 477, 519))
...
"        }")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toolBox.setItemToolTip(self.toolBox.indexOf(self.page_2), _translate("MainWindow", "View all inventory items as read only."))
        ...
        self.actionAuto_back_up_to_cloud.setStatusTip(_translate("MainWindow", "Automatically backups your changes to the cloud."))

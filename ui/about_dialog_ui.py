...
"        }")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("f:\\Code\\Python-Projects\\Inventory Manager\\ui\\BreezeStyleSheets/dist/pyqt6/dark/dialog_ok.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)

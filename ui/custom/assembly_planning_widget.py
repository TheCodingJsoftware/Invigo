...
class AssemblyPlanningWidget(AssemblyWidget):
    ...
    def add_component_to_table(self, component: Component):
        ...
        self.components_table.setItem(
            current_row, self.components_table.notes_column, notes_item
        )
    ...
    def add_laser_cut_part_to_table(self, laser_cut_part: LaserCutPart):
        ...
        self.laser_cut_parts_table.setCellWidget(
            current_row,
            self.laser_cut_parts_table.bending_files_column,
        ...
        self.laser_cut_parts_table.setCellWidget(
            current_row,
            self.laser_cut_parts_table.welding_files_column,
        ...
        self.laser_cut_parts_table.setCellWidget(
            current_row,
            self.laser_cut_parts_table.cnc_milling_files_column,
        ...
        self.laser_cut_parts_table.setCellWidget(
            current_row, self.laser_cut_parts_table.flow_tag_column, flow_tag_combobox
        )
        self.laser_cut_part_table_items[laser_cut_part].update(
        ...
        self.laser_cut_parts_table.setCellWidget(
            current_row,
            self.laser_cut_parts_table.expected_time_to_complete_column,
            expected_time_to_complete,
        )
        self.laser_cut_part_table_items[laser_cut_part].update(
            {"expected_time_to_complete": expected_time_to_complete}
        )

        notes_item = QTableWidgetItem(laser_cut_part.notes)
        self.laser_cut_parts_table.setItem(
            current_row, self.laser_cut_parts_table.notes_column, notes_item
        )
    ...
    def laser_cut_parts_table_changed(self):
        ...
        laser_cut_part.notes = self.laser_cut_part_table_items[laser_cut_part][
            "notes"
        ].text()

...
class LasserCutPartPaintSettingsWidget(QWidget):
    ...
    def __init__(self, laser_cut_part: LaserCutPart, parent: CustomTableWidget):
        ...
        self.widget_primer.setStyleSheet(
            f"QWidget#widget_primer{{border: 1px solid {theme_var('outline')};}}"
        )
        ...
        self.widget_paint_color.setStyleSheet(
            f"QWidget#widget_paint_color{{border: 1px solid {theme_var('outline')};}}"
        )
        ...
        self.widget_powder_coating.setStyleSheet(
            f"QWidget#widget_powder_coating{{border: 1px solid {theme_var('outline')};}}"
        )
    ...
    def update_paint_settings(self):
        ...
        self.laser_cut_part.paint_item = self.paint_inventory.get_paint(
            self.laser_cut_part.paint_name
        )
        self.laser_cut_part.primer_name = self.combobox_primer.currentText()
        self.laser_cut_part.primer_item = self.paint_inventory.get_primer(
            self.laser_cut_part.primer_name
        )
        self.laser_cut_part.powder_name = (
            self.combobox_powder_coating_color.currentText()
        )
        self.laser_cut_part.powder_item = self.paint_inventory.get_powder(
            self.laser_cut_part.powder_name
        )

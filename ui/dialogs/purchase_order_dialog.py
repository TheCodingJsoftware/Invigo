...
class PurchaseOrderDialog(QDialog, Ui_Dialog):
    ...
    def meta_data_changed(self):
        ...
        if self.comboBox_status.currentIndex() == Status.PURCHASE_ORDER.value:
            self.label.setText("PO Number")
        elif self.comboBox_status.currentIndex() == Status.QUOTE.value:
            self.label.setText("Quote Number")
        else:
            self.label.setText("RO Number")
            ...
            for (
                ...
                if vendor := self.get_vendor_by_name(vendor_name):
                    ...
                    for purchase_order in purchase_orders:
                        ...
                        po_item.setText(
                            1,
                            purchase_order.meta_data.status.name.replace("_", " ").title(),
                        )

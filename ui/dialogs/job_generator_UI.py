...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lineEdit_job_name.setClearButtonEnabled(True)
        ...
        self.verticalLayout_6.addWidget(self.lineEdit_search)
        self.checkBox_bring_along_subassemblies = QtWidgets.QCheckBox(parent=self.groupBox)
        self.checkBox_bring_along_subassemblies.setChecked(True)
        self.checkBox_bring_along_subassemblies.setObjectName("checkBox_bring_along_subassemblies")
        self.verticalLayout_6.addWidget(self.checkBox_bring_along_subassemblies)
        self.scrollArea_2 = QtWidgets.QScrollArea(parent=self.groupBox)
        self.scrollArea_2.setWidgetResizable(True)
        self.scrollArea_2.setObjectName("scrollArea_2")
        self.scrollAreaWidgetContents_2 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 1043, 357))
...
"Press \'Merge\' when finished."))
        ...
        self.checkBox_bring_along_subassemblies.setToolTip(_translate("Form", "<html><head/><body><p>With this setting enabled it will bring along all sub-assemblies of the (sub)-assembly you selected.<br/></p><p>With this setting disabled it will only bring along the assembly and no other subsequent sub-assemblies.</p></body></html>"))
        self.checkBox_bring_along_subassemblies.setText(_translate("Form", "Bring along sub-assemblies"))

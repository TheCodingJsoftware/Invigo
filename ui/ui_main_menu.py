...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.labal_category_costs = QtWidgets.QLabel(self.dockWidgetContents)
        self.labal_category_costs.setObjectName("labal_category_costs")
        self.verticalLayout_3.addWidget(self.labal_category_costs)
...
"        }")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labal_category_costs.setText(_translate("MainWindow", "TextLabel"))

...
class LoadWindow(QWidget):
    def __init__(self, parent=None):
        ...
        self.setWindowFlags(
            self.windowFlags() | Qt.WindowType.Window | Qt.WindowType.FramelessWindowHint | Qt.WindowType.WindowStaysOnTopHint | Qt.WindowType.WindowTransparentForInput
        )
        ...
        widget.setStyleSheet(
            "QWidget#widget{ border-top-left-radius:10px; border-bottom-left-radius:10px; border-top-right-radius:10px; border-bottom-right-radius:10px; border: 1px solid #8dcdff; background-color: #292929;}"
        )
        ...
        for _ in range(10):
            ...
            progress_bar.setStyleSheet("background-color: #8dcdff; border-radius: 15px; border: 3px solid #101010;")

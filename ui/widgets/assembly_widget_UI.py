# Form implementation generated from reading ui file '/mnt/SafeHaven/Forge/Inventory Manager/ui/widgets/assembly_widget.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.formLayout_3.setWidget(4, QtWidgets.QFormLayout.ItemRole.LabelRole, self.paint_widget)
        ...
        self.checkBox_has_serial_number = QtWidgets.QCheckBox(parent=self.flowtag_widget_settings)
        self.checkBox_has_serial_number.setObjectName("checkBox_has_serial_number")
        self.formLayout_3.setWidget(3, QtWidgets.QFormLayout.ItemRole.LabelRole, self.checkBox_has_serial_number)
        ...
        self.pushButton_structural_steel_items = QtWidgets.QPushButton(parent=self.assembly_widget)
        self.pushButton_structural_steel_items.setMinimumSize(QtCore.QSize(0, 30))
        ...
        self.verticalLayout_15.addWidget(self.pushButton_structural_steel_items)
        self.structural_steel_items_widget = QtWidgets.QWidget(parent=self.assembly_widget)
        self.structural_steel_items_widget.setObjectName("structural_steel_items_widget")
        self.verticalLayout_20 = QtWidgets.QVBoxLayout(self.structural_steel_items_widget)
        self.verticalLayout_20.setContentsMargins(0, 0, 0, 3)
        self.verticalLayout_20.setSpacing(0)
        self.verticalLayout_20.setObjectName("verticalLayout_20")
        self.verticalLayout_19 = QtWidgets.QVBoxLayout()
        self.verticalLayout_19.setObjectName("verticalLayout_19")
        self.structural_steel_items_layout = QtWidgets.QVBoxLayout()
        self.structural_steel_items_layout.setObjectName("structural_steel_items_layout")
        self.verticalLayout_19.addLayout(self.structural_steel_items_layout)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setContentsMargins(6, 6, 6, 3)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.pushButton = QtWidgets.QPushButton(parent=self.structural_steel_items_widget)
        ...
        self.verticalLayout_15.addWidget(self.structural_steel_items_widget)
    ...
    def retranslateUi(self, Form):
        ...
        self.checkBox_has_serial_number.setToolTip(_translate("Form", "If the part HAS a serial number, it will not be grouped together in Workspace and vice versa."))
        self.checkBox_has_serial_number.setText(_translate("Form", "Has serial number"))

...
class QuoteWidget(QWidget):
    ...
    def __init__(self, quote: Quote, components_inventory: ComponentsInventory, laser_cut_inventory: LaserCutInventory, sheets_inventory: SheetsInventory, sheet_settings: SheetSettings, parent: QWidget) -> None:
        super(QuoteWidget, self).__init__(parent)
        uic.loadUi("ui/quote_widget.ui", self)
    ...
    def load_ui(self):
        ...
        self.comboBox_laser_cutting_2.currentTextChanged.connect(lambda: (self.global_quote_settings_changed(), self.update_sheet_price(), self.update_laser_cut_parts_price()))
        ...
        self.doubleSpinBox_cost_for_laser_2.valueChanged.connect(lambda: (self.global_quote_settings_changed(), self.update_sheet_price(), self.update_laser_cut_parts_price()))
        ...
        self.doubleSpinBox_overhead_items_2.valueChanged.connect(lambda: (self.global_quote_settings_changed(), self.update_components_price(), self.update_laser_cut_parts_price()))
        ...
        self.doubleSpinBox_profit_margin_items_2.valueChanged.connect(lambda: (self.global_quote_settings_changed(), self.update_components_price(), self.update_laser_cut_parts_price()))
        ...
        self.pushButton_item_to_sheet.clicked.connect(lambda: (self.global_quote_settings_changed(), self.update_laser_cut_parts_price()))
        ...
        self.checkBox_components_use_overhead_2.checkStateChanged.connect(lambda: (self.global_quote_settings_changed(), self.update_components_price()))
        ...
        self.checkBox_components_use_profit_margin_2.checkStateChanged.connect(lambda: (self.global_quote_settings_changed(), self.update_components_price()))
        ...
        self.doubleSpinBox_mil_thickness.valueChanged.connect(lambda: (self.global_quote_settings_changed(), self.update_laser_cut_parts_price()))
    ...
    def load_nests(self):
        ...
        for nest in [self.quote.custom_nest] + self.quote.nests:
            ...
            def change_sheet_material(nest_to_change: Nest, combobox: QComboBox):
                ...
                self.nests_tool_box.setItemText(self.nest_items[nest_to_change]["tab_index"], nest_to_change.get_name())
                self.update_sheet_price()
                self.update_laser_cut_parts_price()
                self.load_nest_summary()
    ...
    def load_context_menu(self) -> QMenu:
        ...
        for primer_color in self.paint_inventory.get_all_primers():
            ...
            primer_action.triggered.connect(partial(self.update_selected_laser_cut_parts_paint_settings, "primer", primer_color))
        ...
        for paint_color in self.paint_inventory.get_all_paints():
            ...
            paint_action.triggered.connect(partial(self.update_selected_laser_cut_parts_paint_settings, "paint", paint_color))
        ...
        for powder_color in self.paint_inventory.get_all_powders():
            ...
            powder_action.triggered.connect(partial(self.update_selected_laser_cut_parts_paint_settings, "powder", powder_color))
        ...
        for thickness in self.sheet_settings.get_thicknesses():
            ...
            thickness_action.triggered.connect(partial(self.update_selected_laser_cut_parts_settings, "thickness", thickness))
    ...
    def load_laser_cut_parts(self):
        ...
        for nest in [self.quote.custom_nest] + self.quote.nests:
            ...
            for laser_cut_part in nest.laser_cut_parts:
                ...
                self.laser_cut_table_widget.setItem(row_index, self.laser_cut_table_widget.part_name_column, table_widget_item_name)
                ...
                self.laser_cut_table_widget.setCellWidget(row_index, self.laser_cut_table_widget.paint_type_column, paint_widget)

                self.laser_cut_table_widget.setCellWidget(row_index, self.laser_cut_table_widget.paint_settings_column, paint_settings_widget)
                ...
                self.laser_cut_table_widget.setCellWidget(row_index, self.laser_cut_table_widget.add_to_inventory_column, send_part_to_inventory)
    ...
    def get_laser_cut_part_cost(self, profit_margin: float, overhead: float, cost_of_goods: float, bend_cost: float, labor_cost: float, cost_for_priming: float, cost_for_painting: float, cost_for_powder_coating: float) -> float:
        return (
            calculate_overhead(
                cost_of_goods,
                profit_margin,
    ...
    def update_laser_cut_parts_to_sheet_price(self) -> None:
        ...
        def _calculate_total_cost(laser_cut_parts: list[LaserCutPart]):
            total_item_cost = sum(self.get_laser_cut_part_cost(profit_margin, overhead, part.matched_to_sheet_cost_price, part.bend_cost, part.labor_cost, part.cost_for_primer, part.cost_for_paint, part.cost_for_powder_coating) * part.quantity for part in laser_cut_parts)
    ...
    def update_laser_cut_parts_price(self):
        ...
        for laser_cut_part, table_item_data in self.laser_cut_table_items.items():
            ...
            unit_price = self.get_laser_cut_part_cost(profit_margin, overhead, laser_cut_part.matched_to_sheet_cost_price if self.pushButton_item_to_sheet.isChecked() else laser_cut_part.cost_of_goods, bend_cost, labor_cost, cost_for_priming, cost_for_painting, cost_for_powder_coating)
    ...
    def update_table_costs(self):
        ...
        for laser_cut_part, table_item_data in self.laser_cut_table_items.items():
            unit_price = self.get_laser_cut_part_cost(
                profit_margin, overhead, laser_cut_part.matched_to_sheet_cost_price if self.pushButton_item_to_sheet.isChecked() else laser_cut_part.cost_of_goods, laser_cut_part.bend_cost, laser_cut_part.labor_cost, laser_cut_part.cost_for_primer, laser_cut_part.cost_for_paint, laser_cut_part.cost_for_powder_coating
            )

...
from PyQt6.QtWidgets import QAbstractItemView, QComboBox, QDoubleSpinBox, QInputDialog, QLineEdit, QListWidget, QMenu, QMessageBox, QPushButton, QTableWidget, QTableWidgetItem, QTabWidget, QVBoxLayout, QWidget
...
class PricePerPoundTableWidget(CustomTableWidget):
    def __init__(self, parent=None):
        super(PricePerPoundTableWidget, self).__init__(parent)
...
class PoundsPerSquareFootTableWidget(CustomTableWidget):
    def __init__(self, parent=None):
        super(PoundsPerSquareFootTableWidget, self).__init__(parent)
        self.setShowGrid(True)
        self.setRowCount(0)
        self.setSortingEnabled(False)
        self.setTextElideMode(Qt.TextElideMode.ElideNone)
...
class PoundsPerSquareFootTab(CustomTabWidget):
    def __init__(self, parent: QWidget) -> None:
        super(PoundsPerSquareFootTab, self).__init__(parent)
...
class SheetSettingsTab(QWidget):
    ...
    def remove_material(self):
        try:
            ...
            selected_row = 0
        material_to_remove, ok = QInputDialog.getItem(self, "Remove material", "Select a material to remove", self.sheet_settings.get_materials(), selected_row, False)
    ...
    def remove_thickness(self):
        try:
            ...
            selected_row = 0
        thickness_to_remove, ok = QInputDialog.getItem(self, "Remove thickness", "Select a thickness to remove", self.sheet_settings.get_thicknesses(), selected_row, False)

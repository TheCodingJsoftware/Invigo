...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.line_2 = QtWidgets.QFrame(self.inventory_tab)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 261, 69))
        ...
        self.line = QtWidgets.QFrame(self.inventory_tab)
...
"}")
        ...
        self.pushButton_refresh_price_of_steel = QtWidgets.QPushButton(self.tab_5)
        self.pushButton_refresh_price_of_steel.setMinimumSize(QtCore.QSize(120, 40))
...
"}")
        ...
        self.pushButton_update_price_of_steel = QtWidgets.QPushButton(self.tab_5)
        self.pushButton_update_price_of_steel.setMinimumSize(QtCore.QSize(120, 40))
...
"}")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 246, 321))
...
"}")
        ...
        self.pushButton_refresh_parts_in_inventory = QtWidgets.QPushButton(self.tab)
...
"}")
        ...
        self.pushButton_update_parts_in_inventory = QtWidgets.QPushButton(self.tab)
...
"}")
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 251, 307))
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 194, 330))
        ...
        self.line_7 = QtWidgets.QFrame(self.laser_quote_tab)
        self.line_7.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_7.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_7.setObjectName("line_7")
        self.verticalLayout_nest_directories.addWidget(self.line_7)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_generate_quote.setText(_translate("MainWindow", "Generate"))
